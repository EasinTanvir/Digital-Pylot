...
export const orderStatusEnum = pgEnum("order_status", ["success", "pending", "cancelled"]);
...
export const vehiclesRelations = relations(vehicles, ({ one, many }) => ({
  ...
  subCategory: one(subCategories, { fields: [vehicles.subCategoryId], references: [subCategories.id] }),
