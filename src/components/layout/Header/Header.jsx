    ...
    <header className="sticky top-0 z-30 flex h-16 w-full shrink-0 items-center justify-between border-b border-border-150 bg-white px-4 lg:px-6">
      <div className="  flex items-center gap-3">
        <button
          ...
          className="md:hidden flex h-9 w-9 items-center justify-center rounded-md bg-primary shadow-card outline-none focus-visible:ring-2 focus-visible:ring-secondary md:hidden"
        >
          <Image
